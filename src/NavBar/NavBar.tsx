                ...
                <>
                  ...
                  <NavigationMenuItem>
                    <button
                      ...
                      className={`${navButtonClass} ${
                        location.pathname === '/team' ? 'bg-accent text-accent-foreground' : ''
                      }`}
                    >
                      Team Management
                    </button>
                  ...
                  <NavigationMenuItem>
                    <button
                      ...
                      className={`${navButtonClass} ${
                        location.pathname === '/available' ? 'bg-accent text-accent-foreground' : ''
                      }`}
                    >
                      Spieleranalyse
                    </button>
                  ...
                  <NavigationMenuItem>
                    <button
                      ...
                      className={`${navButtonClass} ${
                        location.pathname === '/team-analyzer' ? 'bg-accent text-accent-foreground' : ''
                      }`}
                    >
                      Teambewertung
                    </button>
                  ...
                  <NavigationMenuItem>
                    <button
                      ...
                      className={`${navButtonClass} ${
                        location.pathname === '/compare' ? 'bg-accent text-accent-foreground' : ''
                      }`}
                    >Spielervergleich
                    </button>
                  </NavigationMenuItem>
