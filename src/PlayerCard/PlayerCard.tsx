...
const PlayerCard: React.FC<IPlayerCardProps> = ({
    ...
    const getRecentPriceChanges = useMemo(() => {
        ...
        const sortedValues = [...playerStats.marketValues].sort(
    ...
    const renderPriceChange = (
        ...
        return (
            <div className="price-change" style={{ color }}>
                ...
                <div className="price-change-percentage">{percentage}%</div>
            </div>
        )
    }
    ...
    const handleNextClick = (e: React.MouseEvent) => {
        e.stopPropagation()
        setCurrentPriceChangeIndex((prev) =>
            Math.min(getRecentPriceChanges.length - 1, prev + 1)
        )
    }
        ...
        >
            ...
            <div className="player-expiry">
                ...
                <span className="expiry-time">
                    {getTimeRemaining(player.exs)}
                </span>
                <span className="expiry-date">
                    {formatExpiryDate(player.dt, player.exs)}
                </span>
            </div>
            ...
            <CustomPriceInput
                ...
                onBuy={() =>
                    onBuyPlayer(player.i, player, parseInt(customPrice, 10))
                }
            ...
            <div className="price-changes-container">
                ...
                <div className="price-changes-wrapper">
                    <div
                        ...
                        style={{
                            transform: `translateX(-${currentPriceChangeIndex * 33.33}%)`,
                        }}
                    >
                ...
                <button
                    ...
                    disabled={
                        currentPriceChangeIndex >=
                        getRecentPriceChanges.length - 1
                    }
                >
                    <FaChevronRight />
                </button>
