    ...
    const handleSelectPlayer = useCallback(
        async (player: Player) => {
            try {
                ...
                const history = await transferHistory.getTransferHistory(
                    leagueId,
                    player.i
                )
                                                ...
                                                >
                                                    {(provided, snapshot) => (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell className="text-right">
                                                                {player.currentOwner
                                                                    ? `${(player.currentOwner.price / 1000000).toFixed(1)}M`
                                                                    : '-'}
                                                            </TableCell>
                                                            <TableCell
