        ...
        <div className="activity-item">
          <div className="activity-image-container">
            <img 
              ...
              onError={(e) => {
                if(!httpClient.usedPlayerIds.has(activity.data.pi)) {
                  httpClient.usedPlayerIds.add(activity.data.pi);
          ...
          <div className="activity-content-wrapper">
            <div className="activity-row activity-row-primary">
              <div className="activity-title">{activity.data.ln.toUpperCase()}</div>
              <div className="activity-price">{formatPrice(activity.data.mv)}</div>
              <div className="activity-comments" onClick={(e) => {
                e.stopPropagation();
            ...
            <div className="activity-row activity-row-secondary">
              <div className="activity-subtitle">
                Neu auf dem Transfermarkt • {getTimeAgo(activity.dt)}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="activity-content-wrapper">
            <div className="activity-row activity-row-primary">
              <div className="activity-title-price">
                <div className="activity-title">{activity.data.pn.toUpperCase()}</div>
                <div className={`activity-price ${isBuy ? 'buy' : 'sell'}`}>
            ...
            <div className="activity-row activity-row-secondary">
              <div className="activity-subtitle">
                {isBuy ? `Gekauft von ${activity.data.byr}` : `Verkauft von ${activity.data.slr}`} • 
      ...
      return (
        <div className="activity-item">
          ...
          <div className="activity-content">
            ...
            <div className="activity-subtitle">
              {formatPrice(activity.data.bn)} • {getTimeAgo(activity.dt)}
            </div>
          </div>
          <div 
...
const ActivityFeed: React.FC<{ leagueId: string }> = ({ leagueId }) => {
  ...
  const fetchActivities = async (pageNumber: number, isInitial: boolean = false) => {
    ...
    try {
      ...
      setActivities(prev => isInitial ? response.af : [...prev, ...response.af]);
      setError(null);
    } catch (err) {
