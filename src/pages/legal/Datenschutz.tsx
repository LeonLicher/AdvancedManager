        ...
        <div className="legal-page">
            <div className="legal-container">
                ...
                <p>
                    ...
                    <br />
                    E-Mail: info@advancedmanager.de
                </p>
                <p>
                ...
                <h3>Cookies</h3>
                <p>
                    Unsere Internetseiten verwenden Cookies. Bei Cookies handelt
                    es sich um Daten, die vom Internetbrowser auf dem
                    Computersystem des Nutzers gespeichert werden. Die Cookies
                    können beim Aufruf einer Seite an diese übermittelt werden
                    und ermöglichen somit eine Zuordnung des Nutzers. Cookies
                    helfen dabei, die Nutzung von Internetseiten für die Nutzer
                    zu vereinfachen.
                </p>
                <p>
                    Es ist jederzeit möglich, der Setzung von Cookies durch
                    entsprechende Änderung der Einstellung im Internetbrowser zu
                    widersprechen. Gesetzte Cookies können gelöscht werden. Es
                    wird darauf hingewiesen, dass bei Deaktivierung von Cookies
                    eventuell nicht alle Funktionen unserer Internetseite
