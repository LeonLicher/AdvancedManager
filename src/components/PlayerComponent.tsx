...
const PlayerComponent: React.FC<PlayerProps> = ({
    ...
    const getPointsColor = (points: number) => {
        ...
        const percentage = Math.min(
            100,
            Math.max(0, (points / maxPoints) * 100)
        )
                    ...
                    <div className="player-points">
                        {isFutureGame ? (
                            <span className="game-date">
                                {formatGameDate(player.gameDate)}
                            </span>
                        ) : (
                            <span
                    ...
                    <div className="player-stats">
                        <div className="stats-column">
                            <div className="stat">
                                ...
                                <span className="stat-value market-value">
                        ...
                        <div className="stats-column">
                            <div className="stat">
                                ...
                                <span className="stat-value avg-points">
                                    {player.averagePoints || '0'}
                                </span>
                            </div>
                            <div className="stat">
                                <span className="stat-label">PPM</span>
                                <span className="stat-value points-per-value">
                                    {pointsPerMillionValue}
                                </span>
                            </div>
                        </div>
                    </div>
