            ...
            <div className="App">
              ...
              <footer className="app-legal-footer">
                <div className="legal-links">
                  <div onClick={() => window.location.href = '/AdvancedManager/impressum'}>Impressum</div>
                  <div onClick={() => window.location.href = '/AdvancedManager/datenschutz'}>Datenschutzerklärung</div>
                  <div onClick={() => window.location.href = '/AdvancedManager/agb'}>AGB</div>
                </div>
                <div className="copyright">
                  &copy; {new Date().getFullYear()} AdvancedManager. Alle Rechte vorbehalten.
                </div>
              </footer>
              ...
              {showCookieConsent && (
                <div className="app-cookie-consent">
                  <p>Diese Website verwendet Cookies, um Ihnen die bestmögliche Funktionalität zu bieten. Durch die Nutzung der Website stimmen Sie der Verwendung von Cookies zu.</p>
                  <div className="cookie-buttons">
                    <button onClick={handleCookieConsent} className="cookie-accept">Akzeptieren</button>
                    <div onClick={() => window.location.href = '/AdvancedManager/datenschutz'} className="cookie-more-info">Mehr erfahren</div>
                  </div>
                </div>
              )}
            </div>
